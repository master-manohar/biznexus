...
define('PLAN_PRICES', [
    'silver' => [
        ...
        'features'       => ['Full CRM Access','Lead Claiming','Group Membership','Priority Support','200 Bonus Coins'],
        'coins_monthly'  => 200,
        'coins_yearly'   => 500,
    ],
    'gold' => [
        ...
        'features'       => ['Everything in Silver','Advanced Analytics','Marketplace Listing','Verified Badge','500 Bonus Coins'],
        'coins_monthly'  => 500,
        'coins_yearly'   => 1500,
        'popular'        => true,
    ],
    'platinum' => [
        ...
        'features'       => ['Everything in Gold','Dedicated Account Manager','Custom Branding','API Access','1000 Bonus Coins'],
        'coins_monthly'  => 1000,
        'coins_yearly'   => 3000,
    ],
]);
