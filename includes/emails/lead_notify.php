...
function sendLeadEmail($member_email, $member_name, $lead_category, $lead_city, $lead_query, $lead_name, $lead_phone) {
    ...
    $content = "
        ...
        <div style='background-color:#1e1e30; padding:15px; border-radius:4px;'>
            ...
            <p style='margin:0 0 5px 0;'><strong>Name:</strong> $lead_name</p>
            <p style='margin:0 0 5px 0;'><strong>Phone/WhatsApp:</strong> <a href='https://wa.me/91$lead_phone' style='color:#00ff88; text-decoration:none;'>$lead_phone</a></p>
        </div>
        
        <p style='margin-top:20px'>Make sure to follow up quickly before other matched members do!</p>
        <a href='https://biznexus.in/leads.php' class='btn'>View in Dashboard</a>
    ";
