...
<div class="container-fluid px-4">
  <a class="navbar-brand" href="/dashboard/index.php" style="color:#FFD700;font-weight:900;font-size:1.4rem">⚡ BizNexus</a>
  ...
  <div class="collapse navbar-collapse" id="navMain">
    <ul class="navbar-nav me-auto gap-1 ms-3">
      <li class="nav-item"><a class="nav-link" href="/dashboard/index.php" style="color:<?=$current_page==='index.php' && str_contains($_SERVER['REQUEST_URI'], '/dashboard/')?'#FFD700':'#888'?>">🏠 Dashboard</a></li>
    ...
    <div class="d-flex align-items-center gap-3">
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end" style="background:#13131a;border:1px solid #2a2a3a">
          <li><a class="dropdown-item" href="/profile/edit.php" style="color:#aaa">👤 My Profile</a></li>
