...
// Helper to prevent fatal crashes if a table does not exist
...
// Fetch coin balance
$coin_balance = safeCount($pdo, "SELECT balance FROM voocoin_balances WHERE user_id = ?", [$user_id]);

// Fetch referrals sent count
$ref_sent = safeCount($pdo, "SELECT COUNT(*) FROM referrals WHERE referrer_id = ?", [$user_id]);

// Fetch referrals received count
$ref_received = safeCount($pdo, "SELECT COUNT(*) FROM referrals WHERE referred_id = ?", [$user_id]);

// Fetch CRM leads count (dispatched leads)
$crm_count = safeCount($pdo, "SELECT COUNT(*) FROM lead_dispatches WHERE member_id = ?", [$user_id]);

// Fetch invoices count
$invoice_count = safeCount($pdo, "SELECT COUNT(*) FROM invoices WHERE user_id = ?", [$user_id]);
...
<aside class="sidebar" id="sidebar">
    <nav class="sidebar-nav">
        ...
        <a href="/leads/list.php" class="sidebar-link">
            <span class="nav-emoji">💼</span>
    ...
    <div class="greeting-date">
        ...
        <a href="/referrals/list.php" class="sidebar-link">
            <span class="nav-emoji">🤝</span>
        ...
        <a href="/marketplace/list.php" class="sidebar-link">
            <span class="nav-emoji">🛒</span>
...
<main class="main-content">
    <div class="page-header">
        ...
        <div class="page-subtitle">Track your leads and VooCoin metrics.</div>
    </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card gold-accent">
                <div class="stat-card-top">
                    ...
                    <div class="stat-trend trend-neutral">Wallet</div>
                </div>
                <div class="stat-value"><?= number_format($coin_balance) ?></div>
                <div class="stat-label">Available VooCoins</div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card green-accent">
                <div class="stat-card-top">
                    ...
                    <div class="stat-trend trend-up">+ Earned</div>
                </div>
                <div class="stat-value"><?= number_format($ref_sent) ?></div>
                <div class="stat-label">Total Referrals Given</div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card blue-accent">
                <div class="stat-card-top">
                    ...
                    <div class="stat-trend trend-neutral">Pipeline</div>
                </div>
                <div class="stat-value"><?= number_format($crm_count) ?></div>
                <div class="stat-label">CRM Leads Dispatched</div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card purple-accent">
                <div class="stat-card-top">
                    ...
                    <div class="stat-trend trend-neutral">Network</div>
                </div>
                <div class="stat-value">100%</div>
                <div class="stat-label">Account Health Score</div>
            </div>
        </div>
    </div>
</main>
